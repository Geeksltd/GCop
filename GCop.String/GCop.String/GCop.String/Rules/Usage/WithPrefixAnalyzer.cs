namespace GCop.String.Rules.Usage
{
    ...
    public class WithPrefixAnalyzer : GCopAnalyzer<SyntaxNodeAnalysisContext, SyntaxKind>
    {
        ...
        protected override RuleDescription GetDescription()
        {
            return new RuleDescription
            {
                ...
                Message = "Write this as {0}.WithPrefix({1})."
            };
        }
        ...
        protected override void Analyze(SyntaxNodeAnalysisContext context)
        {
            ...
            if (identifierName.Identifier.ValueText == "IsEmpty")
            {
                ...
                var variable = addExpression.ChildNodes().LastOrDefault() as IdentifierNameSyntax;
