namespace GCop.Common.FixProvider.Style
{
    ...
    [ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(StaticMethodsBeingCalledinPropertyGetterCodeFixProvider)), Shared]
    public class StaticMethodsBeingCalledinPropertyGetterCodeFixProvider : GCopCodeFixProvider
    {
        private string Title => "Remove class name";

        public override ImmutableArray<string> FixableDiagnosticIds => ImmutableArray.Create("GCop434");
