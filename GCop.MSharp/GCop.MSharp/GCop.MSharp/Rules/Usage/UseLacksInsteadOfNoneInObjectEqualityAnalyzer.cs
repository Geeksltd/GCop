namespace GCop.MSharp.Rules.Usage
{
    ...
    public class UseLacksInsteadOfNoneInObjectEqualityAnalyzer : GCopAnalyzer<SyntaxNodeAnalysisContext, SyntaxKind>
    {
        ...
        protected override RuleDescription GetDescription()
        {
            return new RuleDescription
            {
                ...
                Message = "It should be written as {0}.Lacks({1})"
            };
        }
        protected override void Analyze(SyntaxNodeAnalysisContext context)
        {
            ...
            if (methodInfo.Name != "None" || methodInfo.ContainingAssembly.Name != "MSharp.Framework") return;
            ...
            if (invocation.Expression.DescendantNodes().Any())
                variable = invocation.Expression.DescendantNodesAndSelf().OfType<MemberAccessExpressionSyntax>().FirstOrDefault()?.ToString().Remove(".None");
            else
